...
function authorizationError(error: unknown) {
  ...
  const status = code === "AUTHORIZATION_APPROVER_REQUIRED" || code === "AUTHORIZATION_REQUESTER_REQUIRED" || code === "AUTHORIZATION_SCOPE_FORBIDDEN" || code === "SELF_APPROVAL_NOT_ALLOWED" ? 403
    ...
    : code === "AUTHORIZATION_TYPE_INVALID" || code === "AUTHORIZATION_REASON_REQUIRED" || code === "AUTHORIZATION_REASON_TOO_LONG" || code === "AUTHORIZATION_ENTITY_REQUIRED" || code === "AUTHORIZATION_DECISION_INVALID" || code === "AUTHORIZATION_NOTES_TOO_LONG" ? 400
    : 500;
