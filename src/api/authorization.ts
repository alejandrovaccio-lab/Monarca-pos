...
function authorizationError(error: unknown) {
  ...
  const status = code === "AUTHORIZATION_APPROVER_REQUIRED" || code === "AUTHORIZATION_CRITICAL_APPROVER_REQUIRED" || code === "AUTHORIZATION_REQUESTER_REQUIRED" || code === "AUTHORIZATION_SCOPE_FORBIDDEN" || code === "SELF_APPROVAL_NOT_ALLOWED" ? 403
    ...
    : code === "AUTHORIZATION_TYPE_INVALID" || code === "AUTHORIZATION_REASON_REQUIRED" || code === "AUTHORIZATION_REASON_TOO_LONG" || code === "AUTHORIZATION_ENTITY_REQUIRED" || code === "AUTHORIZATION_ENTITY_TYPE_TOO_LONG" || code === "AUTHORIZATION_DECISION_INVALID" || code === "AUTHORIZATION_NOTES_TOO_LONG" || code === "AUTHORIZATION_ORGANIZATION_INVALID" || code === "AUTHORIZATION_BRANCH_INVALID" || code === "AUTHORIZATION_REQUESTER_INVALID" || code === "AUTHORIZATION_ENTITY_ID_INVALID" || code === "AUTHORIZATION_REQUEST_ID_INVALID" || code === "AUTHORIZATION_APPROVER_ID_INVALID" ? 400
    : 500;
